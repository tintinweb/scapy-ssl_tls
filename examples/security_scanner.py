...
class TLSScanner(object):
    ...
    def _scan_supported_protocol_versions(self, target, starttls=None, versionlist=((k,v) for k,v in TLS_VERSIONS.items() if v.startswith("TLS_") or v.startswith("SSL_"))):
